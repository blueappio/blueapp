...
exports.addDevice = function(params, successHandler, errorHandler) {
	...
	myrequest.sendHttpRequests({
		tags: tags
	}, '/v1/organizations/' + params.orgid + '/tags', 'POST', tagsuccessHandler, tagerrorHandler);
};
...
var createTags = function(params, successHandler, errorHandler) {
	...
	myrequest.sendHttpRequests({
		tags: tags
	}, '/v1/organizations/' + params.orgid + '/tags', 'POST', successHandler, errorHandler);
};
